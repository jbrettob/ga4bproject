package
{
	...
	public class InputHandler extends MovieClip
	{
		...
		private function mouseDown(event:MouseEvent):void
		{
			if (parent)
			{
				if ((parent as Game).gameState == GameSetings.PLAYING && event.target['name'] != 'mcMenu' && event.target['name'] != 'mcMusic' && event.target['name'] != 'mcSound' && event.target['name'] != 'mcQuality')
				{
					_leftMouse = "down";
				}
			}
