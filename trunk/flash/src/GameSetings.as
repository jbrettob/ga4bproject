package 
{
	...
	public class GameSetings extends MovieClip
	{
		...
		//SmallBug		public static var SMALBUGMOVESPEED							:Number = 7;		public static var SMALBUGHEALTH								:Number = 1;		// bugProjectile
		...
		public static var TUTORIALENEMYCOUNT						:Number = 4;
	}
}
